  ...
  const handleImage = (e) => {
    if (files.length > 0 && files.length < 7) {
      ...
      Promise.all(promises)
        ...
        .catch((err) => {
          setImageUploadErr("Max-Size per Image allowed 2MB Only");
          setUploading(false);
        });
    } else {
      setImageUploadErr("Can uploading at most 6 image only");
    }
  };
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          {uploading ? (
            <p className="text-center text-sm text-green-700">
              Image Uploading, may take few seconds
            </p>
          ) : (
            ""
          )}
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                />
                <button
                  className="p-3 text-red-700 rounded-lg uppercase hover:opacity-50"
